...
import { _ as _sfc_main$2 } from "./Layout-DQLSP_yB.js";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="app-surface-card space-y-6 rounded-2xl p-5 sm:p-6"${_scopeId2}>`);
                  ...
                  _push3(`<p class="text-sm font-medium text-emerald-700" style="${ssrRenderStyle(unref(form).recentlySuccessful ? null : { display: "none" })}"${_scopeId2}>Saved.</p></div></form></div>`);
                } else {
                  return [
                    createVNode("div", { class: "app-surface-card space-y-6 rounded-2xl p-5 sm:p-6" }, [
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "flex items-center gap-4" }, [
                          ...
                          createVNode(Transition, {
                            ...
                            default: withCtx(() => [
                              withDirectives(createVNode("p", { class: "text-sm font-medium text-emerald-700" }, "Saved.", 512), [
