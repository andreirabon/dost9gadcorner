            ...
            <div class="app-surface-card space-y-6 rounded-2xl p-5 sm:p-6">
                ...
                <form @submit.prevent="updatePassword" class="space-y-6">
                    <div class="grid gap-2">
                        <Label for="current_password" class="text-sm font-medium text-slate-800">Current password</Label>
                        <Input
                            id="current_password"
                            ref="currentPasswordInput"
                            v-model="form.current_password"
                            type="password"
                            class="mt-1 block h-11 w-full border-slate-300 bg-white text-slate-900 transition-all duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] placeholder:text-slate-400 focus-visible:scale-[1.01] focus-visible:border-slate-400 focus-visible:ring-2 focus-visible:ring-slate-300/80"
                    ...
                    <div class="grid gap-2">
                        <Label for="password" class="text-sm font-medium text-slate-800">New password</Label>
                        <Input
                            id="password"
                            ref="passwordInput"
