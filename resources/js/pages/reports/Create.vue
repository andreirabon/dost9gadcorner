...
<template>
    ...
    >
        <Head title="New report year" />
            ...
            <div class="mx-auto w-full max-w-[920px] space-y-4 px-3 pt-4 pb-8 sm:px-4 md:space-y-5">
                <header class="border-slate-200 border-b pb-4 dark:border-zinc-800">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex min-w-0 items-start gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 max-w-2xl text-sm leading-snug text-slate-600 dark:text-zinc-400">
                ...
                <section class="report-panel scroll-mt-20 p-4 sm:p-5">
                    ...
                    >
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <Button type="submit" variant="outline" class="report-btn-primary h-9 px-5" :disabled="form.processing">
                                Create year
                            </Button>
