            ...
            <header class="report-years-create-header animate-fade-in-up">
                <div class="report-years-create-hero">
                    <div class="report-years-create-hero-top">
                        ...
                        <ReportBackNavLink :href="route('report-years.index')" inline> Back to all years </ReportBackNavLink>
                    </div>
                </div>
            </header>

            <div class="report-years-form-card animate-fade-in-up w-full min-w-0 delay-1">
                <form autocomplete="off" class="report-years-create-form" @submit.prevent="submit">
                    <fieldset class="report-years-fieldset">
                        <legend class="report-years-legend">Reporting period</legend>
                        <p class="report-years-fieldset-hint">Which year this report covers, and whether it is visible to the public.</p>
                        <div class="report-years-create-form-grid">
                            <div class="space-y-2">
                                <Label for="year" class="text-base font-medium text-black">Reporting year</Label>
                                <Input
                                    id="year"
                                    v-model="form.year"
                                    name="year"
                            ...
                            <div class="space-y-2">
                                <Label for="status" class="text-base font-medium text-black">Initial status</Label>
                                <div class="relative">
                                    <select
                                        id="status"
                                        v-model="form.status"
                                        name="status"
                                        class="report-select h-11 w-full appearance-none pr-10 transition-all duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] focus-visible:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-50"
                    ...
                    <fieldset class="report-years-fieldset">
                        <legend class="report-years-legend">Report details</legend>
                        <p class="report-years-fieldset-hint">Both optional. Leave blank and the year is used as the title.</p>

                        <div class="space-y-2">
                            <Label for="title" class="text-base font-medium text-black">
                                Custom title
                            ...
                            <Input
                                ...
                                name="title"
                                type="text"
                                placeholder="e.g., Sex Disaggegated Data Report"
                                :maxlength="REPORT_YEAR_FIELD_LIMITS.title"
                                class="report-field h-11 w-full transition-all duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] focus-visible:scale-[1.01]"
                            />
                            <div class="flex justify-between gap-2">
                                <InputError :message="form.errors.title" />
                                <span class="ml-auto text-sm text-black tabular-nums">
                        ...
                        <div class="space-y-2">
                            <Label for="description" class="text-base font-medium text-black">
                                Description
                                <span class="font-normal text-black">(optional)</span>
                            </Label>
                            <textarea
                                ...
                                name="description"
                                rows="3"
                                placeholder="Brief summary of this data report..."
                    ...
                    <div class="report-years-create-actions">
                        <p v-show="form.recentlySuccessful" class="mr-auto text-sm font-medium text-emerald-700">Saved successfully.</p>
                        <button
                            type="button"
