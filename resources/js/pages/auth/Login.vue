...
<template>
    ...
    <div
        class="scheme-dark relative flex min-h-dvh flex-col bg-linear-to-b from-slate-950 via-blue-950/95 to-slate-950 text-slate-50 selection:bg-blue-500/30"
    >
        <div class="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
            <div class="absolute left-[-10%] top-0 h-[520px] w-[520px] rounded-full bg-blue-500/14 blur-[130px] mix-blend-screen" />
            <div class="absolute right-[-10%] bottom-0 h-[620px] w-[620px] rounded-full bg-cyan-500/12 blur-[150px] mix-blend-screen" />
            <div
                ...
                <section class="w-full lg:flex">
                    ...
                    >
                        ...
                        <form class="space-y-5" @submit.prevent="submit">
                            <div class="space-y-2">
                                <Label for="username" class="text-[13px] font-medium text-slate-100">Username</Label>
                                <div class="relative">
                                    <UserRound
                            ...
                            <div class="space-y-2">
                                <Label for="password" class="text-[13px] font-medium text-slate-100">Password</Label>
                                <div class="relative">
                                    <Lock
                                        class="pointer-events-none absolute top-1/2 left-3 size-4 -translate-y-1/2 text-slate-400"
                                        stroke-width="2"
