...
const femalePercentage = () => {
    const t = total();
    return t === 0 ? 0 : ((props.femaleCount / t) * 100).toFixed(0);
};

const malePercentage = () => {
    const t = total();
    return t === 0 ? 0 : ((props.maleCount / t) * 100).toFixed(0);
};
            ...
            datasets: [
                {
                    ...
                    backgroundColor: ['#3B82F6', '#FBCFE8'], // Blue for female, Light pink for male
                    borderColor: ['#2563EB', '#F9A8D4'],
                    borderWidth: 2,
                },
            ],
        },
        ...
        plugins: [
            {
                ...
                afterDraw: (chart) => {
                    ...
                    const maleMidAngle = femaleMidAngle + femaleSliceAngle / 2 + ((props.maleCount / t) * 2 * Math.PI) / 2;
