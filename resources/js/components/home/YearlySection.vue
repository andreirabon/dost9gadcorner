...
<template>
    <section
        id="yearly"
        class="relative isolate min-h-screen border-t border-white/5 bg-[#0e0716] px-page-gutter pt-12 pb-8 sm:pt-16 md:pt-20 md:pb-10 lg:pt-24"
    ...
    >
        ...
        <div class="relative z-10 mx-auto w-full max-w-7xl">
            ...
            <div class="mb-12 md:mb-16 text-center lg:text-left">
                ...
                >
                    Annual Sex Disaggregated Data <span class="text-violet-400">Reports</span>
                </h2>
